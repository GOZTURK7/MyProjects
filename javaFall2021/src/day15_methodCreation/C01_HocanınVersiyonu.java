...
public class C01_HocanınVersiyonu {
	  ...
	  public static void main(String[] args) {
	        ...
	        String connectedName=null; // Emrah Saglam , E**** S*****
	    
	        if (tercih==1) {
	            connectedName= acikIsim(isim,soyisim);
	        } else if(tercih==2){
	            connectedName=isimGizle(isim,soyisim);
	        }else {
	        ...
	        System.out.println("kullanicinin tercihi : " + connectedName);
