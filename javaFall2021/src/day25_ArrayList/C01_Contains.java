...
public class C01_Contains {
	...
	public static void main(String[] args) {
		...
		/*
		 * Verilen bir arrayde tekrar eden elementleri, sadece birer tane yazarak unique
		 * elementlerden oluşan bir array haline getirelim.
		 */
		...
		System.out.println(tekrarsiz); // [2, 3, 4, 5, 6, 7, 8, 9, 1, 0]
