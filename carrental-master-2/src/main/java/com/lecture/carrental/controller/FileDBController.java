...
public class FileDBController {
    ...
    @GetMapping("/{id}") // resmi indirmeye yarayan method indirme işlemini yapacak
    public ResponseEntity<byte[]> getFile(@PathVariable String id) {
        FileDB fileDB = fileDBService.getFileById(id);

        return ResponseEntity.ok().header(HttpHeaders.CONTENT_DISPOSITION, // headerler meta dataların tutulduğu yer
