...
public class H3_Save {
	...
	public static void main(String[] args) {
		...
		System.out.println(session.save(student1)); // SYSO İÇİNDE ATSAYDIK BUNU KAYDEDİLEN OBJENİN İD'SİNİ DÖNDÜRÜYOR. ONU YAZDIRIRDI 1111;
