...
public class QManav_HalukHocaCozumu_RecursiveMethod {
    ...
    private static void musteriSecim() {
        ...
        int karar = scan.nextInt();  // BU SORUNUN TRİCK'İ BUNUN ALTINDAN SONRA musteriSecim() METHODU
        // BAŞKA METHOD İÇİNDE METHOD İLE LOOP YAPILIYOR BUNA RECRUSİVE METHOD DENİYOR.
        if (karar == 1) {
            musteriSecim();
        } else {
            kasa();
