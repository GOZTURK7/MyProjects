...
public class NotHesaplama {
    public static void main(String[] args) {
    	...
    	System.out.println("Vize Sınav Sonucunuzu Girinizi:");
    	double vize = scan.nextDouble();
    	System.out.println("Vize Sınav Yüzdesini Girinizi:");
    	double vizeYuzdesi = scan.nextDouble();
    	System.out.println("Final Sınav Sonucunuzu Girinizi:");
    	double fnl = scan.nextDouble();
    	System.out.println("Final Sınav Yüzdesini Girinizi:");
