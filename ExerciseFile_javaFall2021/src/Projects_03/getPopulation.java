...
public class getPopulation {
	...
	/*
	 * Method adı populationOfCountry Bu method 1 String array(countryNames) , 1 int
	 * array (countryPopulations) ve 1 String (str) alacak
	 * 
	...
	public int populationOfCountry(String[] country, int[] countryPopulation, String cName) {

		for (int i = 0; i < countryPopulation.length; i++) {

			if (country[i].equalsIgnoreCase(cName)) {
				int index = country[i].indexOf(cName);
				return countryPopulation[index];
			}
		}return -1;
