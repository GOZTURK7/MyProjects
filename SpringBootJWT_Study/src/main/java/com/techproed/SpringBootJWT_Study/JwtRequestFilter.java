...
@Service //@Component anatasyonu da kullanılabilir.
public class JwtRequestFilter extends OncePerRequestFilter { // bu class client'den gelen request ile app'ten gelen token compare/karşılaştırma methodunu barındırır.
