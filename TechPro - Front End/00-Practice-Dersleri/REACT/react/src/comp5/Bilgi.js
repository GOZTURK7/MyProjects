  ...
  return(
    ...
    <Card style={{ width: '18rem' }}>
        ...
        <Card.Body>
            ...
            <Button variant="primary" onClick={sonraki}>Next</Button>
            <Button variant="success" onClick={karisik}>Rondom</Button>
            <Button variant="secondary" onClick={onceki}>Prev</Button>
