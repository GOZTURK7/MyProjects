...
let satirlar = document.querySelectorAll("#liste tbody tr");

for(satir of satirlar){

    // const maas = satir.querySelectorAll("td:last-child").innerText;
    const maas = satir.querySelectorAll("td")[2].innerText;
    if(maas > 5000){
...
// //////////////////////////////////////////////////////////////////////////
// e.Personeller diye bir başlık ekleyelim.
...
mesaj.setAttribute("class", "text-center");
